...
static msg_t RegelungSyncthread(void *arg) 
{
  	...
  	while (TRUE) 
	{
		if(Datalogger_ready() && !datalog_regelung_opened)
		{
				...
				{
					f_printf(&Fil_regelung, "Parameter: kp_roll=%d , i_roll=%d , i_roll_offset=%d, i_nick_offset=%d, d_roll=%d, kp_nick=%d,i_nick=%d,d_nick=%d, kp_gier=%d,i_gier=%d,d_gier=%d\r\nTime_regelung;In_Throttle;In_Soll_Nick;In_Soll_Roll;In_Soll_Gier;In_Ist_Nick;In_Ist_Roll;In_Ist_Gier;In_Ist_V_Nick;In_Ist_V_Roll;Out_M_Roll;Out_M_Nick;Out_M_Gier;Out_F_A;Out_F_B;Out_F_C;Out_F_D;Out_n_A;Out_n_B;Out_n_C;Out_n_D;kp_roll;i_roll;d_roll;kp_nick;i_nick;d_nick;fifocnt;I_roll_offset_m;I_nick_offset_m;hoehe_tp;h_z;p_anteil;i_anteil;d_anteil;v_z;hoehe_act;h_rest_integrator;hoehe;schubkraftout;In_Ist_V_Gier;p_gier_m;i_gier_m;d_gier_m;I_gier_offset_m\r\n",(long int)(kp_roll*10000) , (long int)(i_roll*10000), (long int)(i_roll_offset*10000),(long int)(i_nick_offset),(long int)(d_roll*10000), (long int)(kp_nick*10000), (long int)(i_nick*10000), (long int)(d_nick*10000), (long int)(kp_gier*10000), (long int)(i_gier*10000), (long int)(d_gier*10000));
...
static msg_t RegelungPrintthread(void *arg) 
{
	while (TRUE) 
	{
		if(readcounter!=writecounter && Datalogger_ready() && datalog_regelung_opened && datalog_regelung_syncing==0)
		{
			...
			f_printf(&Fil_regelung, "%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d;%d\r\n",
...
void datalog_regelung(void)
{
  ...
  regelung_databuffer[writecounter][20]=(long int)(p_roll_m*10000);
	regelung_databuffer[writecounter][21]=(long int)(i_roll_m*10000);
	regelung_databuffer[writecounter][22]=(long int)(d_roll_m*10000);
	regelung_databuffer[writecounter][23]=(long int)(p_nick_m*10000);
  ...
  regelung_databuffer[writecounter][29]=(long int)(hoehe_tp*10000);
  regelung_databuffer[writecounter][30]=(long int)(h_z*10000);
	regelung_databuffer[writecounter][31]=(long int)(p_anteil*10000);
	regelung_databuffer[writecounter][32]=(long int)(i_anteil*10000);
	regelung_databuffer[writecounter][33]=(long int)(d_anteil*10000);
	regelung_databuffer[writecounter][34]=(long int)(v_z*10000);
	regelung_databuffer[writecounter][35]=(long int)(hoehe_act*10000);
	regelung_databuffer[writecounter][36]=(h_rest_integrator*10000);
  regelung_databuffer[writecounter][37]=(long int)(Hoehenregelung_U.Hoehe*10000);
  regelung_databuffer[writecounter][38]=(long int)(Hoehenregelung_Y.Schubkraft*10000);
	regelung_databuffer[writecounter][39]=(long int)(Regelglied_U.In_Ist_V_Gier*10000);
	regelung_databuffer[writecounter][40]=(long int)(p_gier_m*10000);
	regelung_databuffer[writecounter][41]=(long int)(i_gier_m*10000);
	regelung_databuffer[writecounter][42]=(long int)(d_gier_m*10000);
	 regelung_databuffer[writecounter][43]=(long int)(I_gier_offset_m*10000);
	writecounter++;

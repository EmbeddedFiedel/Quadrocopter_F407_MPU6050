...
/* Generated by genpubheader from export/include/SimulinkBlock/rtw/construct.hpp. */
...
namespace RTW
{
    ...
    static void construct_code_for_user_block(SimStruct *S, void *rtwBlk)
    {
        try
        {
            static SFun_BlockFunctionTable* pFcnTable = build_BlockFunctionTable<DerivedBlock>();
            do_construct_code<DerivedBlock>(S, rtwBlk, pFcnTable);

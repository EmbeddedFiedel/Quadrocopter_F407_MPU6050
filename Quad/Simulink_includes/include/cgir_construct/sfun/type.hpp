...
/* Generated by genpubheader from export/include/cgir_construct/rtw_api/type.hpp. */
...
namespace RTW
{
    ...
    Type vectorOf(const Type& elementType,
                  size_t size,
...
namespace RTW
{
    ...
    {
        SFun_Type_Impl* pResult = SFun_pointerTo_T(
                                        baseType.getImpl());
        return Type(pResult);
    }

    inline Type vectorOf(const Type& elementType,
                         size_t size,
                         DimensionsMode_T dimsMode)
    {
        SFun_Type_Impl* pResult = SFun_vectorOf_T_sz_DM(
                                        elementType.getImpl(),
                                        size,
                                        dimsMode);
        return Type(pResult);
    ...
    {
        SFun_Type_Impl* pResult = SFun_unsizedVectorOf_T_sz_DM(
                                        elementType.getImpl());
        return Type(pResult);
    }
    ...
    inline Type matrixOf(const Type& elementType,
                         ...
                         DimensionsMode_T dimsMode)
    {
        SFun_Type_Impl* pResult = SFun_matrixOf_T_sz_sz_DM(
                                        elementType.getImpl(),
                                        rows,
                                        columns,
                                        dimsMode);
    ...
    {
        SFun_Type_Impl* pResult = SFun_matrixOf_T_DI_DM(
                                        elementType.getImpl(),
                                        &dimensions,
                                        dimsModes);
        return Type(pResult);
